"""Run ``unified_hello_pyside6`` with the stock PySide6 native host."""
...
SOURCE_PATH = Path(__file__).with_name("unified_hello_pyside6.py")
...
def _load_component() -> Any:
    ...
    namespace = load_transformed_namespace(
        source,
        module_name="examples.unified_hello_pyside6",
        filename=str(SOURCE_PATH),
    )
    return namespace["unified_hello_pyside6"]
