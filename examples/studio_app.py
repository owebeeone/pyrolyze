...
class StudioMainWindow(QMainWindow):
    ...
    def setup_ui(self):
        ...
        # Main content - create vertical splitter for editor area and bottom panel
        self.content_widget = QWidget()
        self.content_layout_inner = QVBoxLayout(self.content_widget)
        self.content_layout_inner.setContentsMargins(0, 0, 0, 0)
        
        # Create vertical splitter for editor area and bottom panel
        ...
        self.panel_layout = QVBoxLayout(self.panel_area)
        self.panel_layout.setContentsMargins(0, 0, 0, 0)
        
        # Panel tabs
        self.panel_tabs = QTabWidget()
        self.panel_tabs.setTabPosition(QTabWidget.North)  # Tabs at top like VS Code
        
        # Output tab
        self.output_widget = QWidget()
        self.output_layout = QVBoxLayout(self.output_widget)
        self.output_layout.setContentsMargins(8, 8, 8, 8)
        ...
        self.terminal_layout.setContentsMargins(8, 8, 8, 8)
        ...
        # Add tabs to panel
        self.panel_tabs.addTab(self.output_widget, "Output")
        self.panel_tabs.addTab(self.terminal_widget, "Terminal")
        
        # Style panel tabs to match VS Code
        ...
        # Add editor area and panel to vertical splitter
        self.vertical_splitter.addWidget(self.editor_area)
        self.vertical_splitter.addWidget(self.panel_area)
        
        # Set initial sizes - editor area takes most space
        self.vertical_splitter.setSizes([400, 150])  # Editor: 400px, Panel: 150px
        
        # Style vertical splitter
        ...
        self.content_layout_inner.addWidget(self.vertical_splitter)
