...
#
# WARNING:
# This module intentionally contains pre-lowered component-ref definitions.
# It is NOT regular author-style PyRolyze source and should not be copied as a
# pattern for application code.
#
# Why this exists:
# - The helper surface must be importable in contexts where the PyRolyze import
#   hook may be disabled.
# - Imported helper detection currently relies on runtime metadata
#   (`_pyrolyze_meta`) being present at import time.
#
# For author-style reference syntax, see `elements.py` in this same package.
#
