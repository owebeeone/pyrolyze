...
class RenderContextStateMgr(ContextBaseStateMgr):
    def __init__(
        ...
        **kwargs: Any,
        ...
        super().__init__(owner, render_context_state_mgr=None, **kwargs)
        self._context_kind = (
            ContextKind.RENDER_ROOT if owner_slot_state_mgr is None else ContextKind.COMPONENT_RENDER
        )
        ...
        self._render_context_state_mgr = self
