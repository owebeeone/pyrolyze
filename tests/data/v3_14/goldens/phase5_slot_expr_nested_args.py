...
def __pyr_panel(__pyr_ctx, __pyr_dirty_state, a: int):
    with __pyr_ctx.pass_scope():
        ...
        v1, v2 = __pyr_ctx.slot_expr(lambda v1, v2: v2.eval(), lambda v1, v2: v2.dirty()).slot_call('v1', __pyr_LiteralFunctionProvider(slot_f2), lambda: __pyr_slot_params(1, a), lambda: __pyr_slot_params_dirt(False, __pyr_dm.bind.a), slot_id=__pyr_slot_1).slot_call('v2', __pyr_LiteralFunctionProvider(slot_f1), lambda v1: __pyr_slot_params(v1.eval()), lambda v1: __pyr_slot_params_dirt(v1.dirty()), slot_id=__pyr_slot_2).apply_dirt_sink(__pyr_dm).evaluate('v1', 'v2')
        pair = (v1, v2)
