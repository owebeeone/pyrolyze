...
__pyr_slot_2 = __pyr_SlotId(__pyr_module_id, 2, line_no=20, is_top_level=True)
__pyr_slot_3 = __pyr_SlotId(__pyr_module_id, 3, line_no=26, is_top_level=True)
__pyr_slot_4 = __pyr_SlotId(__pyr_module_id, 4, line_no=26, is_top_level=True)
__pyr_slot_5 = __pyr_SlotId(__pyr_module_id, 5, line_no=32, is_top_level=True)
__pyr_slot_6 = __pyr_SlotId(__pyr_module_id, 6, line_no=32, is_top_level=True)
...
class Panel:
    ...
    def __pyr_Panel__show(self, __pyr_ctx, __pyr_dirty_state, label: str):
        with __pyr_ctx.pass_scope():
            ...
            value = __pyr_ctx.slot_expr(globals()['__pyr_slot_1'], lambda v1: v1.eval(), lambda v1: v1.dirty()).slot_call('v1', globals()['__pyr_LiteralFunctionProvider'](upper), lambda: globals()['__pyr_slot_params'](label), lambda: globals()['__pyr_slot_params_dirt'](__pyr_dm.bind.label), slot_id=globals()['__pyr_slot_2']).apply_dirt_sink(__pyr_dm).evaluate('value')
    ...
    def __pyr_Panel__build(cls, __pyr_ctx, __pyr_dirty_state, label: str):
        with __pyr_ctx.pass_scope():
            __pyr_dm = globals()['__pyr_dm_from_dirty_state'](__pyr_dirty_state)
            value = __pyr_ctx.slot_expr(globals()['__pyr_slot_3'], lambda v2: v2.eval(), lambda v2: v2.dirty()).slot_call('v2', globals()['__pyr_LiteralFunctionProvider'](upper), lambda: globals()['__pyr_slot_params'](label), lambda: globals()['__pyr_slot_params_dirt'](__pyr_dm.bind.label), slot_id=globals()['__pyr_slot_4']).apply_dirt_sink(__pyr_dm).evaluate('value')
    ...
    def __pyr_Panel__static(__pyr_ctx, __pyr_dirty_state, label: str):
        with __pyr_ctx.pass_scope():
            __pyr_dm = globals()['__pyr_dm_from_dirty_state'](__pyr_dirty_state)
            value = __pyr_ctx.slot_expr(globals()['__pyr_slot_5'], lambda v3: v3.eval(), lambda v3: v3.dirty()).slot_call('v3', globals()['__pyr_LiteralFunctionProvider'](upper), lambda: globals()['__pyr_slot_params'](label), lambda: globals()['__pyr_slot_params_dirt'](__pyr_dm.bind.label), slot_id=globals()['__pyr_slot_6']).apply_dirt_sink(__pyr_dm).evaluate('value')
            record('static:' + value)
